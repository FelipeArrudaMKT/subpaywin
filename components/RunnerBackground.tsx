...
export const RunnerBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 bg-[#050505] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-green-900/10 via-black to-black opacity-100"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,rgba(34,197,94,0.05),transparent_70%)] animate-breathe opacity-100"></div>
      ...
      <div className="absolute top-[40%] left-1/2 -translate-x-1/2 w-[120%] h-[60%] perspective-1000">
        <div className="absolute inset-0 flex justify-center">
          {/* Main Perspective Rails - Using standard Tailwind transform syntax */}
          <div className="absolute w-[2px] h-[200%] bg-green-500/20 -translate-x-48 origin-top [transform:rotateY(-20deg)]"></div>
          <div className="absolute w-[2px] h-[200%] bg-green-500/20 translate-x-48 origin-top [transform:rotateY(20deg)]"></div>
